...
import ge.bootcamp.travel19.model.airports.restrictionsbyairport.GVA
import ge.bootcamp.travel19.model.generalRestrictions.GeneralRestrictions
import ge.bootcamp.travel19.ui.fragments.AirportsViewModel
   ...
   // private lateinit var restr: GVA
    ...
    private suspend fun fetchRestrictionsByAirport(loc:String, dest: String, nationality:String, vaccine:String) {
        lifecycleScope.launchWhenStarted {
            airportsViewModel.fetchRestrictionsByAirport(loc, dest, nationality, vaccine).collect { state ->
                when (state) {
                    is Resource.Success -> {
