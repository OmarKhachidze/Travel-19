...
//                RegisterFragmentDirections.actionRegisterFragmentToMiHome()
//            )
//        }
//
...
//        binding.eVaccines.setAdapter(vaccinesAdapter)
//
//        val nationalitiesAdapter = ArrayAdapter(requireContext(), R.layout.list_item, nationalities)
//        binding.eNationalities.setAdapter(nationalitiesAdapter)
//
//
...
//    }
    ...
    private fun saveUserData() {
        userInfo = UserInfo(
            binding.eEmail.text.toString(), binding.ePassword.text.toString(),
...
////                        userAdapter.submitList(state.data)
//                        Log.d("data", state.data!!.toString())
//                        viewModel.saveTokenToDataStore(
//                            stringPreferencesKey("AuthToken"),
